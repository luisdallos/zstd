...
if(ZSTD_MULTITHREAD_SUPPORT)
    ...
    if(MINGW OR MSVC)
        # Multi-threading support on Windows XP (requires winpthreads library)
        option(ZSTD_MULTITHREAD_WINXP_SUPPORT "Enable multi-threading support on Windows XP" OFF)
        if(ZSTD_MULTITHREAD_WINXP_SUPPORT)
            message(STATUS "Multi-threading support on Windows XP is enabled")
        else()
            message(STATUS "Multi-threading support on Windows XP is disabled")
        endif()
    endif()
else()
